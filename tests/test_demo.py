...
from homeassistant.components.sensor.demo import (
    CONF_UNIT, CONF_AMP, CONF_MEAN, CONF_PERIOD, CONF_PHASE, CONF_FWHM,
    CONF_SEED, DEFAULT_NAME, DEFAULT_AMP, DEFAULT_MEAN, DEFAULT_UNIT,
    DEFAULT_PHASE, DEFAULT_PERIOD, DEFAULT_FWHM, DEFAULT_SEED)
...
class TestSimulatedSensor(unittest.TestCase):
    ...
    def test_default_config(self):
        ...
        state = self.hass.states.get('sensor.outside_humidity')
